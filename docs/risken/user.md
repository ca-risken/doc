...
## Organizationのアクセス権限を管理する {#_8}

### ユーザーにOrganizationのロールを付与する {#_9}
...
操作方法はプロジェクトのIAMと同じであるため、詳細については[プロジェクトのアクセス権限を管理する](/risken/user/#_2)を参照してください。

### Organization IAMをプロジェクトへ継承する {#_10}
